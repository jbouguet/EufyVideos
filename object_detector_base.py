...
class ObjectDetectorFactory:
    ...
    def create_detector(
        ...
        # if model == Model.FLORENCE2.value:
        #     return Florence2ObjectDetector(
        #         model_name="microsoft/Florence-2-large",
        #         conf_threshold=conf_threshold,
        #     )
        # elif model == Model.YOLO10N.value:
        #     return YoloObjectDetector(
        #         model_name="yolo10n.pt", conf_threshold=conf_threshold
        #     )
        # elif model == Model.YOLO10S.value:
        #     return YoloObjectDetector(
        #         model_name="yolo10s.pt", conf_threshold=conf_threshold
        #     )
        # elif model == Model.YOLO10M.value:
        #     return YoloObjectDetector(
        #         model_name="yolo10m.pt", conf_threshold=conf_threshold
        #     )
        # elif model == Model.YOLO10L.value:
        #     return YoloObjectDetector(
        #         model_name="yolo10l.pt", conf_threshold=conf_threshold
        #     )
        # elif model == Model.YOLO10X.value:
        #     return YoloObjectDetector(
        #         model_name="yolo10x.pt", conf_threshold=conf_threshold
        #     )
        # elif model == Model.YOLO11N.value:
        #     return YoloObjectDetector(
        #         model_name="yolo11n.pt", conf_threshold=conf_threshold
        #     )
        # elif model == Model.YOLO11S.value:
        #     return YoloObjectDetector(
        #         model_name="yolo11s.pt", conf_threshold=conf_threshold
        #     )
        # elif model == Model.YOLO11M.value:
        #     return YoloObjectDetector(
        #         model_name="yolo11m.pt", conf_threshold=conf_threshold
        #     )
        # elif model == Model.YOLO11L.value:
        #     return YoloObjectDetector(
        #         model_name="yolo11l.pt", conf_threshold=conf_threshold
        #     )
        # elif model == Model.YOLO11X.value:
        #     return YoloObjectDetector(
        #         model_name="yolo11x.pt", conf_threshold=conf_threshold
        #     )
        # elif model == Model.YOLO10N_OPTIMIZED.value:
        #     return OptimizedYoloObjectDetector(
        #         model_name="yolo10n.pt",
        #         conf_threshold=conf_threshold,
        #         batch_size=batch_size,
        #     )
        # elif model == Model.YOLO10S_OPTIMIZED.value:
        #     return OptimizedYoloObjectDetector(
        #         model_name="yolo10s.pt",
        #         conf_threshold=conf_threshold,
        #         batch_size=batch_size,
        #     )
        # elif model == Model.YOLO10M_OPTIMIZED.value:
        #     return OptimizedYoloObjectDetector(
        #         model_name="yolo10m.pt",
        #         conf_threshold=conf_threshold,
        #         batch_size=batch_size,
        #     )
        # elif model == Model.YOLO10L_OPTIMIZED.value:
        #     return OptimizedYoloObjectDetector(
        #         model_name="yolo10l.pt",
        #         conf_threshold=conf_threshold,
        #         batch_size=batch_size,
        #     )
        # elif model == Model.YOLO10X_OPTIMIZED.value:
        #     return OptimizedYoloObjectDetector(
        #         model_name="yolo10x.pt",
        #         conf_threshold=conf_threshold,
        #         batch_size=batch_size,
        #     )
        # elif model == Model.YOLO11N_OPTIMIZED.value:
        #     return OptimizedYoloObjectDetector(
        #         model_name="yolo11n.pt",
        #         conf_threshold=conf_threshold,
        #         batch_size=batch_size,
        #     )
        # elif model == Model.YOLO11S_OPTIMIZED.value:
        #     return OptimizedYoloObjectDetector(
        #         model_name="yolo11s.pt",
        #         conf_threshold=conf_threshold,
        #         batch_size=batch_size,
        #     )
        # elif model == Model.YOLO11M_OPTIMIZED.value:
        #     return OptimizedYoloObjectDetector(
        #         model_name="yolo11m.pt",
        #         conf_threshold=conf_threshold,
        #         batch_size=batch_size,
        #     )
        # elif model == Model.YOLO11L_OPTIMIZED.value:
        #     return OptimizedYoloObjectDetector(
        #         model_name="yolo11l.pt",
        #         conf_threshold=conf_threshold,
        #         batch_size=batch_size,
        #     )
        # elif model == Model.YOLO11X_OPTIMIZED.value:
        #     return OptimizedYoloObjectDetector(
